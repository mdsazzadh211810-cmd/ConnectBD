          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2 text-xs font-medium">
              ...
              <button 
                ...
                className={`px-2.5 py-0.5 rounded text-[11px] font-bold border transition-all hover:scale-105 flex items-center space-x-1 ${
                ...
                title="Click on your name to view account details and user data"
              >
                <span>{currentUser.role === 'admin' ? '👑 Admin' : `👤 ${currentUser.name || 'Customer'}`}</span>
              </button>
            </div>
            <span className="text-slate-700">|</span>
            <button 
